...
const mapLevels=()=>{
    ...
    return(<>
            <h2 class="ui block header">
              <a href="/" >Home </a> | {props.currentUser ? <a><a href="/" >LogOut </a> | <a path="/user" onClick={()=>props.onHandleClick("userProfile")} > Profile </a> </a>: <a> <a href="/" >LogIn </a>  | <a href="/signup" >SignUp </a> </a>}
            </h2>
